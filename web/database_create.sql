...
CREATE TABLE IF NOT EXISTS `capture_data_file` (
  ...
  `parent_capture_data_element_repository_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `capture_dataset` (
  `capture_dataset_repository_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `capture_device_component` (
  ...
  `parent_capture_device_repository_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `file_upload` (
  ...
  `parent_record_type` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `item` (
  `item_repository_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `model` (
  `model_repository_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `parent_capture_dataset_repository_id` int(11) DEFAULT NULL,
  `parent_item_repository_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `photogrammetry_scale_bar_target_pair` (
  ...
  `parent_photogrammetry_scale_bar_repository_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `processing_action` (
  ...
  `parent_model_repository_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subject` (
  `subject_repository_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `created_by_user_account_id` (`created_by_user_account_id`),
  KEY `last_modified_user_account_id` (`last_modified_user_account_id`),
  KEY `projects_id` (`project_repository_id`,`subject_name`)
...
CREATE TABLE IF NOT EXISTS `subject_type` (
  `subject_type_repository_id` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) NOT NULL DEFAULT '',
  `date_created` datetime NOT NULL,
  `created_by_user_account_id` int(11) NOT NULL,
  `last_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `last_modified_user_account_id` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`subject_type_repository_id`),
  KEY `created_by_user_account_id` (`created_by_user_account_id`),
  KEY `last_modified_user_account_id` (`last_modified_user_account_id`)
...
ALTER TABLE model add column parent_model_id int(11) DEFAULT NULL;
...
CREATE TABLE IF NOT EXISTS `model_file` (
  ...
  `model_repository_id` int(11) NOT NULL,
