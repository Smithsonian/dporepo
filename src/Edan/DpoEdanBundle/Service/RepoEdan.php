...
namespace Edan\DpoEdanBundle\Service;
...
class RepoEdan implements RepoEdanInterface
{
    ...
    */
    public function __construct(string $edan_url, string $edan_app_id, string $edan_auth_token, string $edan_version, string $edan_search_endpoint, string $edan_content_endpoint)
    {
