...
class LightSourceTypesController extends Controller
{
    ...
    public function __construct(AppUtilities $u)
    {
        ...
        $this->table_name = 'light_source_types';
        $this->id_field_name_raw = 'light_source_types_id';
        $this->id_field_name = 'light_source_types.' . $this->id_field_name_raw;
        $this->label_field_name_raw = 'label';
        $this->label_field_name = 'light_source_types.' . $this->label_field_name_raw;
    }
     ...
     */
    public function datatables_browse_light_source_types(Connection $conn, Request $request)
    {
        $sort = '';
        $search_sql = '';
        $pdo_params = array();
    ...
    function show_light_source_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        ...
        $data = !empty($post) ? $post : $this->get_one((int)$light_source_types_id, $conn);
    ...
    */
     ...
     * Delete Record
     *
     * Run a query to delete a Light Source Type record.
     *
