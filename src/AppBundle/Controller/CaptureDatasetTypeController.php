...
class CaptureDatasetTypeController extends Controller
{
    /**
     * @var object $u
     */
    ...
    public function __construct(AppUtilities $u, Connection $conn)
    {
        ...
        $this->id_field_name_raw = 'dataset_type_id';
     ...
     */
    public function datatablesBrowseDatasetTypes(Request $request)
    {
     ...
     * @return  array|bool            The query result
     */
    function showDatasetTypesForm(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
