...
class CalibrationObjectTypesController extends Controller
{
     ...
     */
    public function datatables_browse_calibration_object_types(Connection $conn, Request $request)
    {
        $sort = '';
        $search_sql = '';
        $pdo_params = array();
    ...
    function show_calibration_object_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        ...
        $data = !empty($post) ? $post : $this->get_one((int)$calibration_object_types_id, $conn);
    ...
    */
     ...
     * Delete Record
     *
     * Run a query to delete a Calibration Object Type record.
     *
