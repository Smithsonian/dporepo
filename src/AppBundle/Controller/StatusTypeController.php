...
class StatusTypeController extends Controller
{
    ...
    public function __construct(AppUtilities $u, Connection $conn)
    {
        ...
        $this->id_field_name_raw = 'status_type_id';
     ...
     */
    public function datatablesBrowseStatusTypes(Request $request)
    {
     ...
     * @return  array|bool            The query result
     */
    function showStatusTypesForm(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
