...
class TargetTypesController extends Controller
{
     ...
     */
    public function datatables_browse_target_types(Connection $conn, Request $request)
    {
        $sort = '';
        $search_sql = '';
        $pdo_params = array();
    ...
    function show_target_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        ...
        $data = !empty($post) ? $post : $this->get_one((int)$target_types_id, $conn);
    ...
    */
     ...
     * Delete Record
     *
     * Run a query to delete a Target Type record.
     *
