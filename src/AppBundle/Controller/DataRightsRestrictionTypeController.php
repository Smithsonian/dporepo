...
class DataRightsRestrictionTypeController extends Controller
{
    /**
     * @var object $u
     */
    ...
    public function __construct(AppUtilities $u, Connection $conn)
    {
        ...
        $this->table_name = 'data_rights_restriction_type';
        $this->id_field_name_raw = 'data_rights_restriction_type_id';
        $this->id_field_name = 'data_rights_restriction_type.' . $this->id_field_name_raw;
        $this->label_field_name_raw = 'label';
        $this->label_field_name = 'data_rights_restriction_type.' . $this->label_field_name_raw;
    }
     ...
     *
     * Run a query to retrieve all Data Rights Restriction Types in the database.
     *
     * @param   object  Request     Request object
     * @return  array|bool          The query result
     */
    public function datatablesBrowseDataRightsRestrictionTypes(Request $request)
    {
        ...
        $query_params = array(
          'record_type' => 'data_rights_restriction_type',
     ...
     * @return  array|bool            The query result
     */
    function showDataRightsRestrictionTypesForm(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
