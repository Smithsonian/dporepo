...
class StatusTypesController extends Controller
{
    ...
    /**
     * @Route("/admin/resources/status_types/", name="status_types_browse", methods="GET")
     */
    ...
    /**
     * @Route("/admin/resources/status_types/datatables_browse_status_types", name="status_types_browse_datatables", methods="POST")
     *
     * Browse Status Types
     *
     ...
     */
    public function datatables_browse_status_types(Connection $conn, Request $request)
    {
        $sort = '';
        $search_sql = '';
        $pdo_params = array();
     ...
     * @return  array|bool            The query result
     */
    function show_status_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        $errors = false;
        $data = array();
        $gump = new GUMP();
        ...
        $data = !empty($post) ? $post : $this->get_one((int)$status_types_id, $conn);
    ...
    */
    ...
    /**
     * Delete Multiple Status Types
     *
     * @Route("/admin/resources/status_types/delete", name="status_types_remove_records", methods={"GET"})
     ...
     * Delete Record
     *
     * Run a query to delete a Status Type record.
     *
