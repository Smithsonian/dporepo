...
class FocusTypesController extends Controller
{
    ...
    /**
     * @Route("/admin/resources/focus_types/", name="focus_types_browse", methods="GET")
     */
    ...
    /**
     * @Route("/admin/resources/focus_types/datatables_browse_focus_types", name="focus_types_browse_datatables", methods="POST")
     *
     * Browse Focus Types
     *
     * Run a query to retreive all Focus Types in the database.
     *
     * @param   object  Connection  Database connection object
     * @param   object  Request     Request object
     * @return  array|bool          The query result
     */
    public function datatables_browse_focus_types(Connection $conn, Request $request)
    {
        $sort = '';
        $search_sql = '';
        $pdo_params = array();
    ...
    /**
     * Matches /admin/resources/focus_types/manage/*
     *
     * @Route("/admin/resources/focus_types/manage/{focus_types_id}", name="focus_types_manage", methods={"GET","POST"}, defaults={"focus_types_id" = null})
     *
     * @param   int     $id           The focus_type ID
     * @param   object  Connection    Database connection object
     * @param   object  Request       Request object
     * @return  array|bool            The query result
     */
    function show_focus_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        ...
        $focus_types_id = !empty($request->attributes->get('focus_types_id')) ? $request->attributes->get('focus_types_id') : false;
        $data = !empty($post) ? $post : $this->get_one((int)$focus_types_id, $conn);
        ...
        if (!$errors && !empty($post)) {
            $focus_types_id = $this->insert_update($post, $focus_types_id, $conn);
    ...
    */
    ...
    /**
     * Delete Multiple Focus Types
     *
     * @Route("/admin/resources/focus_types/delete", name="focus_types_remove_records", methods={"GET"})
     ...
     * Delete Record
     *
     * Run a query to delete a Focus Type record.
     *
