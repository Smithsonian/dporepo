...
class ScaleBarBarcodeTypesController extends Controller
{
    ...
    /**
     * @Route("/admin/resources/scale_bar_barcode_types/", name="scale_bar_barcode_types_browse", methods="GET")
     */
    ...
    /**
     * @Route("/admin/resources/scale_bar_barcode_types/datatables_browse_scale_bar_barcode_types", name="scale_bar_barcode_types_browse_datatables", methods="POST")
     *
    ...
    function show_scale_bar_barcode_types_form(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
        ...
        $data = !empty($post) ? $post : $this->get_one((int)$scale_bar_barcode_types_id, $conn);
    ...
    */
    ...
    /**
     * Delete Multiple Scale Bar Barcode Types
     *
     * @Route("/admin/resources/scale_bar_barcode_types/delete", name="scale_bar_barcode_types_remove_records", methods={"GET"})
     ...
     * Delete Record
     *
     * Run a query to delete a Scale Bar Barcode Type record.
     *
