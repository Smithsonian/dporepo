...
class TargetTypeController extends Controller
{
    ...
    public function __construct(AppUtilities $u, Connection $conn)
    {
        ...
        $this->id_field_name_raw = 'target_type_id';
    ...
    /**
     * @Route("/admin/resources/target_types/", name="target_types_browse", methods="GET")
     */
    ...
    /**
     * @Route("/admin/resources/target_types/datatables_browse_target_types", name="target_types_browse_datatables", methods="POST")
     *
     * Browse Target Types
     *
     ...
     */
    public function datatablesBrowseTargetTypes(Request $request)
    {
     ...
     * @return  array|bool            The query result
     */
    function showTargetTypesForm(Connection $conn, Request $request, GumpParseErrors $gump_parse_errors)
    {
    ...
    /**
     * Delete Multiple Target Types
     *
     * @Route("/admin/resources/target_types/delete", name="target_types_remove_records", methods={"GET"})
