...
class CaptureMethodController extends Controller
{
     ...
     */
    public function datatablesBrowseCaptureMethods(Request $request)
    {
     ...
     * @return  array|bool            The query result
     */
    function showCaptureMethodsForm( Connection $conn, Request $request, GumpParseErrors $gump_parse_errors )
    {
