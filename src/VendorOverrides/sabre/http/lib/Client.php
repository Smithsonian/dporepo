...
// NOTE!
// This is a modified copy of the Client class, which resides in:
...
// Issue:
// Warning: curl_exec(): CURLOPT_INFILE resource has gone away, resetting to default
// See: https://github.com/sabre-io/http/issues/89
//
// BUT, can't update sabre/http to latest due to the following 4.2.x dependency:
//
// composer require sabre/http:5.0.0
//
// sabre/dav 3.2.2 requires sabre/http ^4.2.1 -> satisfiable by sabre/http[4.2.1, 4.2.2, 4.2.3, 4.2.x-dev, v4.2.4]
